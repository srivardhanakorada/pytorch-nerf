...
def main(device="cuda:0"):
    ...
    plt.savefig("results/tiny_param_4_4/{}/test_img.png".format(folder_name))
    ...
    for i in range(num_iters):
        ...
        if i % display_every == 0:
            ...
            plt.title("PSNR")
            if i % plot_every == 0:
                plt.savefig("results/tiny_param_4_4/{}/iter_{}.png".format(folder_name,i))
            F_c.train()
            plt.close()
    ...
    np.save("results/tiny_param_4_4/{}/psnrs.npy".format(folder_name), psnrs)
    logging.info("Saving model")
    torch.save(F_c.state_dict(), "results/tiny_param_4_4/{}/F_c.pth".format(folder_name))
    logging.info("Saving optimizer")
    torch.save(optimizer.state_dict(), "results/tiny_param_4_4/{}/optimizer.pth".format(folder_name))
    logging.info("DONE!")
