...
def main(device="cuda:0",num_iters=20000):
    ...
    results_folder = f"/home/yasaswinib/Vardhan/pytorch-nerf/new_results/tiny_param_6_var/{name}"
    seed = 9458
...
if __name__ == "__main__":
    device = "cuda:0"
    logging.basicConfig(filename='/home/yasaswinib/Vardhan/pytorch-nerf/new_results/tiny_param_6_logs_var/car.log', level=logging.INFO, format='%(asctime)s - %(levelname)s - %(message)s')
