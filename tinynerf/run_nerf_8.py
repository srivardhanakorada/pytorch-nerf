...
def main(device="cuda:0",num_iters=20000):
    ...
    results_folder = f"/home/yasaswinib/Vardhan/pytorch-nerf/new_results/tiny_param_8/{name}"
    seed = 9458
...
if __name__ == "__main__":
    device = "cuda:3"
    logging.basicConfig(filename='/home/yasaswinib/Vardhan/pytorch-nerf/new_results/tiny_param_8_logs/car.log', level=logging.INFO, format='%(asctime)s - %(levelname)s - %(message)s')
