...
from image_encoder_var import ImageEncoder
...
def main():
    ...
    F_c.load_state_dict(torch.load("results/pixel/oneshot/03790512/F_c.pth"))
    F_f.load_state_dict(torch.load("results/pixel/oneshot/03790512/F_f.pth"))
    print("Models loaded!")
    ...
    plt.show()
    # store_folder = "/data/home1/saichandra/Vardhan/projectAIP/pytorch-nerf/results/pixel/oneshot/03790512/" + "test_aft.png"
